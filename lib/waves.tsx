...
import { createSvgCompositionContext } from "./svg-composition-context";
  ...
  for (let i = 0; i < numWaves; i++) {
    waves.push(
      <g key={i} transform={`translate(0 ${y}) scale(${scale} ${scale})`}>
        <g>
          <Wave fill={compCtx.fill} stroke={compCtx.stroke} />
          <animateTransform
  ...
  return (
    <>
      ...
      <div className="sidebar waves">
        <div className="sidebarTitle">Wave Settings</div>
        <RandomizerWidget
...
export const Waves: React.FC<{}> = () => <WavesRender />;
